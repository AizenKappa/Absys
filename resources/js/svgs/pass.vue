<template>
    <div class="relative ">
                  ...
                  <input  placeholder="Mot de passe" class="form-control select-none block w-full px-3 py-1.5 text-base font-normal text-gray-700
        ...
        <span class="cursor-pointer absolute top-2 right-2 pointer h-5 w-5" 
                        @click="open = !open">       
            <template v-if="open">
